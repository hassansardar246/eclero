            ...
            <div className="sm:hidden fixed top-[56px] left-0 right-0 z-40 px-4">
                <div className="mx-auto w-[95vw] max-w-xl rounded-2xl bg-white shadow-xl border border-gray-200 overflow-hidden">
                    <div className="flex flex-col p-2">
                        ...
                        <Link onClick={() => setMenuOpen(false)} href="/auth/login" className="mt-1 px-3 py-3 rounded-lg bg-blue-600 text-white text-center font-semibold hover:bg-blue-700">Log In</Link>
                    </div>
                </div>
            </div>
        ) : null}

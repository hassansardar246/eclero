    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium border transition-all duration-200 ${
                isAvailableNow
                  ...
                  : "bg-white/10 text-yellow-400 border-white/30 hover:bg-white/20"
              } ${
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {/* Stats cards */}
          <div
            className="bg-white/10 backdrop-blur-md overflow-hidden shadow-2xl rounded-2xl border border-white/20"
        ...
        <div className="mt-8">
          <div
            className="bg-white/10 backdrop-blur-md shadow-2xl overflow-hidden sm:rounded-2xl border border-white/20"
            style={{ boxShadow: "0 8px 32px 0 rgba(31,38,135,0.37)" }}
          >
